...
function getContentDetails(contentType, req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (contentId) {
            ...
            data.relatedMovies = yield (0, axios_1.getDataFromTMDB)(`https://api.themoviedb.org/3/${contentType}/${contentId}/similar`);
            console.log(`Related ${contentType}s received, total= ${data.relatedMovies.total_results}`);
